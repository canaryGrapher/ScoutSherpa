...
function create_fragment$2(ctx) {
  let div;
  let show_if_1 = !isUndefined( /*step*/ctx[2].options.title) || /*step*/ctx[2].options.cancelIcon && /*step*/ctx[2].options.cancelIcon.enabled;
  let t0;
  let show_if = !isUndefined( /*step*/ctx[2].options.text);
  let t1;
  let shepherdfooter;
  let current;
  ...
  return {
    ...
    m(target, anchor) {
      ...
      append(div, t1);
      mount_component(shepherdfooter, div, null);
      current = true;
    },
    p(ctx, _ref) {
      let [dirty] = _ref;
      if (dirty & /*step*/4) show_if_1 = !isUndefined( /*step*/ctx[2].options.title) || /*step*/ctx[2].options.cancelIcon && /*step*/ctx[2].options.cancelIcon.enabled;
      if (show_if_1) {
        if (if_block0) {
          if_block0.p(ctx, dirty);
          if (dirty & /*step*/4) {
      ...
      if (dirty & /*step*/4) show_if = !isUndefined( /*step*/ctx[2].options.text);
      if (show_if) {
        if (if_block1) {
          if_block1.p(ctx, dirty);
          if (dirty & /*step*/4) {
    ...
    d(detaching) {
      ...
      if (if_block0) if_block0.d();
      if (if_block1) if_block1.d();
      destroy_component(shepherdfooter);
    }
  };
}
function instance$2($$self, $$props, $$invalidate) {
  ...
  return [descriptionId, labelId, step, tourName];
}
...
function create_fragment$1(ctx) {
  ...
  return {
    c() {
      ...
      toggle_class(div, "shepherd-has-cancel-icon", /*hasCancelIcon*/ctx[6]);
      toggle_class(div, "shepherd-has-title", /*hasTitle*/ctx[7]);
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    ...
    $$invalidate(10, focusableElements = element.querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]'));
    $$invalidate(9, firstFocusableElement = focusableElements[0]);
    $$invalidate(11, lastFocusableElement = focusableElements[focusableElements.length - 1]);
  });
  afterUpdate(() => {
  ...
  */
  ...
  $$self.$$set = $$props => {
    if ('classPrefix' in $$props) $$invalidate(12, classPrefix = $$props.classPrefix);
    if ('element' in $$props) $$invalidate(0, element = $$props.element);
    if ('descriptionId' in $$props) $$invalidate(2, descriptionId = $$props.descriptionId);
    if ('firstFocusableElement' in $$props) $$invalidate(9, firstFocusableElement = $$props.firstFocusableElement);
    if ('focusableElements' in $$props) $$invalidate(10, focusableElements = $$props.focusableElements);
    if ('labelId' in $$props) $$invalidate(3, labelId = $$props.labelId);
    if ('lastFocusableElement' in $$props) $$invalidate(11, lastFocusableElement = $$props.lastFocusableElement);
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*step*/16) {
      {
        $$invalidate(6, hasCancelIcon = step.options && step.options.cancelIcon && step.options.cancelIcon.enabled);
        $$invalidate(7, hasTitle = step.options && step.options.title);
      }
    }
  };
  return [element, dataStepId, descriptionId, labelId, step, tourName, hasCancelIcon, hasTitle, handleKeyDown, firstFocusableElement, focusableElements, lastFocusableElement, classPrefix, getElement, div_binding];
}
class Shepherd_element extends SvelteComponent {
  constructor(options) {
    ...
    init(this, options, instance$1, create_fragment$1, safe_not_equal, {
      ...
      element: 0,
      descriptionId: 2,
      firstFocusableElement: 9,
      focusableElements: 10,
      labelId: 3,
      lastFocusableElement: 11,
      step: 4,
      dataStepId: 1,
      tourName: 5,
      getElement: 13
    ...
    if (step) {
      ...
      if (shouldSkipStep) {
        ...
        const getPageFromArray = dataArray => {
          var _dataArray$find;
          return ((_dataArray$find = dataArray.find(item => item.hasOwnProperty('page'))) == null ? void 0 : _dataArray$find.page) || null;
        };
        const pageVPV = getPageFromArray(window.dataLayer);
        if (tourInstanceCaller === this.options.instanceCaller && pageVPV === step.options.pageLink) {
          step.show();
        }
      }
    }
