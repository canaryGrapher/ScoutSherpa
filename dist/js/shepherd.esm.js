 ...
 */
const offset = function offset(options) {
  if (options === void 0) {
    options = 0;
  }
  return {
...
function create_fragment$7(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "shepherd-cancel-icon");
      attr(div0, "type", "button");
      attr(div1, "class", "shepherd-cancel-icon-container");
    },
    m(target, anchor) {
      insert(target, div1, anchor);
      append(div1, div0);
...
/* src\js\components\shepherd-progress-bar.svelte generated by Svelte v3.59.2 */
