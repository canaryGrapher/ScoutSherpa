...
UCJTwoWheelerLoanTour.addStep({
    ...
    attachTo: {
        element:
            '#AdditionalPage > div.page-content.stylesheet.center-all4.main-page.form-page > div > div.col-main.col-main-1 > div:nth-child(3)',
        on: 'right'
    },
    advanceOn: {
        selector:
...
UCJTwoWheelerLoanTour.addStep({
    ...
    attachTo: {
        element:
            '#AdditionalPage > div.page-content.stylesheet.center-all4.main-page.form-page > div > div.col-main.col-main-1 > div.style.mt-3.row > div:nth-child(2)',
        on: 'right'
    },
    advanceOn: {
        selector:
