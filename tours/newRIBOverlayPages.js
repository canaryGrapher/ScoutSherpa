...
// update 12: content for bank accounts updated x 3
...
var NewRIBAccountsPage = () => {
  ...
  GuideMeWhatsOnNewRIBBankAccountsPage.addStep({
    ...
    canClickTarget: false,
    text: `<div><ul>
    <li>Click on "Add Funds" to add money to your savings account through UPI</li>
    <li>Click on "View Statement" to view your Account Statement.</li>
    <li>Select Overdraft Account and then click "Pay Now" to settle the utilized amount, through your savings or overdraft account.</li>
    </ul><div style="text-align: center;"><img src="https://cdn.jsdelivr.net/gh/canaryGrapher/ScoutSherpa@newRIB/tours/images/buttonDetailsBankAccounts.gif" alt="Animation showing use of new ICICI website dialer" style="object-fit: contain;margin-top:10px;" crossorigin="anonymous" width="100%" /></div></div>`,
    attachTo: {
